...
// Random number (jQuery supplied random number generator)		
		var barColorOne = Math.floor(Math.random() * 9);
		var barHeightOne = Math.floor(Math.random() * 20);
		var barColorTwo = Math.floor(Math.random() * 9);
		var barHeightTwo = Math.floor(Math.random() * 20);
		var barColorThree = Math.floor(Math.random() * 9);
		var barHeightThree = Math.floor(Math.random() * 20);
		var barColorFour = Math.floor(Math.random() * 9);
		var barHeightFour = Math.floor(Math.random() * 20);
		var barColorFive = Math.floor(Math.random() * 9);
...
var barColor = ['962f34', '004023', '0a4159', '9b6c21', '724f10', 'ece5da', '000000', '808080', 'ffffff'];
